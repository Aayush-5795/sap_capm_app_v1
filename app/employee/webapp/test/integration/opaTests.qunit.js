...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "aayush/employee/employee/test/integration/FirstJourney",
    "aayush/employee/employee/test/integration/EmployeeSetListJourney",
    "aayush/employee/employee/test/integration/EmployeeSetObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
